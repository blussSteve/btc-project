...
public class FileUtil {
	...
	public String uploadFile(MultipartFile file) {
		...
		if (originalFilename.contains(".")) {
			newName += originalFilename.substring(originalFilename
					.lastIndexOf("."));
		}
	...
	public void downFile(String fileName, HttpServletRequest req,
			HttpServletResponse rsp) throws IOException {
		if (StringUtils.isEmpty(fileName)) {
			rsp.sendError(Integer.parseInt(RspCodeEnum.$1103.getCode()),
					RspCodeEnum.$1103.getDesc());
			return;
		}
	 ...
	 * @return
	 */
	public String getFilePathByUrl(String downFilePath) {
		String fileName = StringUtils.substringAfter(downFilePath, "downFile/");
		String savePath = filePath + fileName;
		return savePath;
	}
