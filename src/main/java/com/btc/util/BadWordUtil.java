...
//	
//	@Autowired
//	private BadWrodMapper badWrodMapper;
//	
//	private static BadWordUtil instance;
//	
//	@PostConstruct 
//	public void init() {
//		instance = this;
//		instance.redisService = this.redisService;
//		instance.badWrodMapper=this.badWrodMapper;
//		
//		List<String> list=badWrodMapper.selectAll(1);//默认1
//		Set<String> keyWordSet = new HashSet<String>();
//		for(String word:list){
//			keyWordSet.add(word);
//		}
//		BadWordUtil.words = keyWordSet;
//		addBadWordToHashMap(BadWordUtil.words);
//	}
//	
//	
